...
이번 변경 검증: 순수 C# 검사 201개 통과. Core·Runtime·PlayMode 테스트 소스의 참조 컴파일도 확인했다. 컴파일에는 Unity 2021.3 참조 DLL, 공식 uGUI 2018.4 소스의 참조용 호환 수정, Input System/Unity 6 GetMesh API의 컴파일용 대체 선언을 사용했다. Unity 6000.3.5f2의 실제 임포트·PlayMode 실행·오디오 재생을 대체하는 검증은 아니다.

...
namespace BBSB.Core
{
    ...
    public static class WeaponCatalog
    {
        ...
        private static WeaponDefinition[] Build()
        {
            ...
            new WeaponDefinition("round-shield", WeaponKind.Shield,
                new WeaponActionDefinition(GestureKind.Hold, "방어 전개", "완료 시 방어막 16 · 4박 유지", WeaponAttackStyle.Guard, 0, guard: 16),
                new WeaponActionDefinition(GestureKind.Shake, "방패 밀치기", "8 피해 + 방어막 6 · 4박 유지", WeaponAttackStyle.ShieldBash, 8, guard: 6)),
            new WeaponDefinition("tower-shield", WeaponKind.Shield,
                new WeaponActionDefinition(GestureKind.Hold, "방어 전개", "완료 시 방어막 20 · 4박 유지", WeaponAttackStyle.Guard, 0, guard: 20),
                new WeaponActionDefinition(GestureKind.Shake, "방패 밀치기", "10 피해 + 방어막 8 · 4박 유지", WeaponAttackStyle.ShieldBash, 10, guard: 8)),
            new WeaponDefinition("heater-shield", WeaponKind.Shield,
                new WeaponActionDefinition(GestureKind.Hold, "방어 전개", "완료 시 방어막 12 · 4박 유지", WeaponAttackStyle.Guard, 0, guard: 12),
                new WeaponActionDefinition(GestureKind.Shake, "방패 밀치기", "8 피해 + 방어막 6 · 4박 유지", WeaponAttackStyle.ShieldBash, 8, guard: 6)),
            new WeaponDefinition("wide-shield", WeaponKind.Shield, 2,
                new WeaponActionDefinition(GestureKind.Hold, "양면 방어", "왼쪽 선봉 · 오른쪽 후열", WeaponAttackStyle.Guard, 0, guard: 12),
                new WeaponActionDefinition(GestureKind.Shake, "방패 밀치기", "방어", WeaponAttackStyle.ShieldBash, 8, guard: 6)),
            new WeaponDefinition("resonance-shield", WeaponKind.Shield,
                new WeaponActionDefinition(GestureKind.Hold, "속성 축적", "막은 피해를 속성치로 축적", WeaponAttackStyle.Guard, 0, guard: 12),
                new WeaponActionDefinition(GestureKind.Shake, "공명", "같은 속성의 다음 공격 강화", WeaponAttackStyle.Ward, 0, guard: 6)),

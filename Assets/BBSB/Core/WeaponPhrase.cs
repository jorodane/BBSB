    ...
    public static class WeaponPhraseCatalog
    {
        ...
        private static readonly WeaponPhrase[] phrases = {
            ...
            new WeaponPhrase("heater-shield", "Heater Shield", "Hold 2 beats · press to parry · guard 50% · cooldown 2 beats", 2,
                ...
                startGridBeats: 0, holdDamageReduction: .5m, releaseEndsPhrase: true, parryRequired: false,
            ...
            new WeaponPhrase("dagger", "단검", "Tap on beat → next note +1 beat · miss cooldown 2 beats", 1,
                new[] { Tap(0, 6) }, startGridBeats: 1),

...
namespace BBSB.Runtime.UI
{
    ...
    public sealed class MonsterCodexStage : MonoBehaviour
    {
        ...
        internal void Bind(RunUI ui, MonsterDefinition monster, MonsterAttackSprites sprites)
        {
            ...
            body = ui.Background(portrait, Color.white); body.preserveAspect = true;
        ...
        internal void Refresh(double seconds, bool response)
        {
            ...
            RunUI.Pin(body.rectTransform, Vector2.zero, new Vector2(.5f, 0), foot, new Vector2(height * aspect, height));
            ...
            for (int i = 0; i < attacks.Count; i++)
            {
                ...
                var sprite = sprites.Attack(definition, frame, 2, beat, out bool exact);
                float h = height * (float)definition.Height;

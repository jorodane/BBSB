...
{
    /// <summary>Development menu only. The separate pattern menu shows the placed monsters.</summary>
    internal sealed class MusicPreview
    {
        ...
        public void Draw(RunUI ui, Transform parent, Action redraw)
        {
            ...
            ui.Label(card, "슬롯 후보를 보여줘. 이번 전투의 몬스터는 메뉴의 몬스터 패턴에서 확인해.", 20, RunUI.Muted, 70);
        }
